package controllers;
// debemos instalar swingx-all : https://jar-download.com/download-handling.php
...
public class ProductsController implements ActionListener, MouseListener, KeyListener {
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == views.btn_register_product) {
            ...
            if (row == -1) {
                ...
                int question = JOptionPane.showConfirmDialog(null, "¿Confirma eliminar este producto?");
    ...
    public void mouseClicked(MouseEvent e) {
        if (e.getSource() == views.products_table) {
            ...
            views.jTabbedPane2.setSelectedIndex(0);
            cleanTable();
            limpiarCampos();
            listAllProducts();
