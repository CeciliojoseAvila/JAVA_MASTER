...
public class EmployeesController implements ActionListener, MouseListener, KeyListener {
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == views.btn_register_employee) {
        ...
        } else if (e.getSource() == views.btn_modify_data) { //btn modificar 
            ...
            // Verificar si las cajas de texto están vacias
    ...
    public void mouseClicked(MouseEvent e) {
        if (e.getSource() == views.employees_table) {
            ...
            if (rol.equals("Administrador")) {
                views.jTabbedPane2.setSelectedIndex(3);
                // Limpiar tabla
                cleanTable();
                // Limpiar campos
                limpiarCampos();
                ...
                views.jTabbedPane2.setEnabledAt(3, false);
