...
public class SuppliersController implements ActionListener, MouseListener, KeyListener {
    ...
    public void mouseClicked(MouseEvent e) {
        if (e.getSource() == views.suppliers_table) {
            ...
            if (rol.equals("Administrador")) {
                views.jTabbedPane2.setSelectedIndex(4);
                cleanTable();
                limpiarCampos();
                //Listar proveedores
                listAllSuppliers();
            } else {
                views.jTabbedPane2.setEnabledAt(4, false);
                views.jLabelSuppliers.setEnabled(false);
                JOptionPane.showMessageDialog(null, "No tienes privilegios para acceder a esta vista");
            }
        }
    }
