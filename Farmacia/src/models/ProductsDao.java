...
public class ProductsDao {
    ...
    public boolean registerProductQuery(Products product) {
        ...
        try {
            ...
            pst.setDouble( 4, product.getUnit_price());//setDouble 
            pst.setTimestamp(5, datetime);
            pst.setTimestamp(6, datetime);
            pst.setInt(7, product.getCategory_id()); //setInt
    ...
    public List listProductQuery(String value) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                product.setUnit_price(rs.getDouble("unit_price"));//setDouble
    ...
    public boolean updateProductQuery(Products product) {
        ...
        try {
            ...
            pst.setDouble(4, product.getUnit_price());//setDouble 
            pst.setTimestamp(5, datetime);
            pst.setInt(6, product.getCategory_id()); //setInt            
    ...
    public boolean deleteProductQuery(int id) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, 
                    " No puede eliminar un producto que tenga relacion con otra tabla");
   ...
   // METODO BUSCAR PRODUCTOS POR CODIGO
    ...
    public Products searchId(int id) {        
        ...
        try {
            ...
            if (rs.next()) {                      
            product.setProduct_quantity(rs.getInt("product_quantity")); //getString = getInt          
            }
